    ...
    <div className="max-w-4xl mx-auto flex flex-col h-[75vh] argus-glass rounded-[2rem] overflow-hidden border border-zinc-800 relative">
      ...
      <form onSubmit={handleSend} className="p-4 border-t border-zinc-800 bg-zinc-900/50 flex items-center gap-3">
        ...
        <button
          ...
          className="h-12 w-12 rounded-xl bg-white text-black hover:bg-white/90 hover:scale-[1.02] shadow-[0_10px_30px_rgba(0,0,0,0.5)] flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
          {sending ? (
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="h-12 px-8 rounded-xl bg-white text-black hover:bg-white/90 hover:scale-[1.02] shadow-[0_10px_30px_rgba(0,0,0,0.5)] font-black text-[11px] uppercase tracking-[0.2em] transition-all shadow-[0_10px_40px_rgba(0,0,0,0.5)] flex items-center gap-2"
                  >
