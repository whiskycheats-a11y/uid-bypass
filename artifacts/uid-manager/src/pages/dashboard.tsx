...
function OverviewStatCard({
  ...
  return (
    <motion.div
      ...
      className="bg-zinc-900  border border-zinc-800 shadow-[0_20px_40px_rgba(0,0,0,0.6)] glow-border rounded-[2rem] p-6 sm:p-7 relative overflow-hidden cursor-default group flex items-center justify-between shadow-xl"
    >
      ...
      <div className="flex flex-col items-end justify-between h-full relative z-10 gap-3">
        <div className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center group-hover:bg-zinc-800 transition-colors shadow-[0_10px_40px_rgba(0,0,0,0.5)] group-hover:shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
          <Icon className="w-4 h-4 text-white/80 group-hover:text-white/90 transition-colors" />
        </div>
        <div className="w-24 sm:w-28 h-10 mt-2">
          <svg viewBox="0 0 100 30" className="w-full h-full text-zinc-400 group-hover:text-white/90 transition-colors filter drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            <motion.path
              d={pathD}
              fill="none"
              stroke="currentColor"
  ...
  return (
    <div className="relative" onClick={(e) => e.stopPropagation()}>
      <button
        ...
        className="w-full h-11 pl-10 pr-4 rounded-xl text-sm font-semibold transition-all outline-none flex items-center justify-between group bg-zinc-900/50 "
        style={{
      ...
      >
        <CalendarDays className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400 group-hover:text-white/90 transition-colors" />
        <span className="truncate">{selected.label}</span>
        <motion.span
          animate={{ rotate: isOpen ? 180 : 0 }}
          transition={{ duration: 0.2 }}
          className="text-zinc-400 group-hover:text-white shrink-0 ml-2"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 w-full rounded-2xl overflow-hidden p-1.5 space-y-1 bg-zinc-900/50  border border-white/20 shadow-[0_30px_60px_rgba(0,0,0,0.9)]"
          >
            {options.map((opt) => {
              ...
              return (
                <button
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl text-xs font-semibold flex items-center justify-between transition-all hover:bg-zinc-900"
                  style={{
                    background: active
          ...
          >
            <div className="relative w-24 h-24 flex items-center justify-center mb-6">
              ...
              <motion.div
                ...
                className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-full flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] z-10"
              >
              ...
              <motion.div
                ...
                className="absolute inset-[-10px] border-2 border-blue-500/20 border-t-emerald-400 rounded-full z-0"
              />
            </div>
            <motion.h3
              ...
              className="text-2xl font-black text-white tracking-widest drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]"
            >
              ACCESS GRANTED
            </motion.h3>
            <motion.p
              ...
              className="text-blue-400 font-bold uppercase tracking-[0.2em] text-[10px] mt-2 text-center"
            >
...
━━━━━━━━━━━━━━━━━━━━━━━━━━`;
  ...
  return (
    <div className="max-w-xl mx-auto space-y-4">
      <div className="panel rounded-[2rem] overflow-hidden argus-glass text-left border border-zinc-800">
        <div className="h-px" style={{ background: "linear-gradient(90deg, transparent, #fbbf24, #ef4444, transparent)" }} />
        <div className="px-6 py-5 border-b border-white/[0.04] flex items-center gap-3 bg-zinc-900/50">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-amber-500/10 border border-amber-500/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            <Gift className="w-5 h-5 text-amber-400" />
          </div>
          <div>
            <h2 className="font-black text-base text-white tracking-wide">Free Trial Link Generator</h2>
            <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">Generate trial links to share with clients</p>
          </div>
        </div>
          ...
          <AnimatePresence mode="wait">
            {linkData ? (
              <motion.div key="creds" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="space-y-5">
                <div className="flex items-center gap-3.5 p-4 rounded-2xl bg-emerald-500/5 border border-blue-500/20">
                  <motion.div animate={{ scale: [1, 1.15, 1] }} transition={{ duration: 1.5, repeat: Infinity }} className="w-9 h-9 rounded-xl flex items-center justify-center bg-emerald-500/20 border border-blue-500/20">
                    <Check className="w-5 h-5 text-blue-400" />
                  </motion.div>
                  <div>
                    <p className="text-sm font-black text-blue-400">Trial Link Created!</p>
                    <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">Valid for 24h to activate — share the activation link</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={f.key} className="flex items-center justify-between p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800">
                      <div className="flex-grow min-w-0 pr-4">
                        <div className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-1.5">{f.label}</div>
                        <div className="font-mono font-bold text-sm text-white truncate">{f.value}</div>
                      </div>
                      <button onClick={() => copyField(f.value, f.key)} className="p-2 rounded-lg transition-all hover:bg-white/[0.06] text-zinc-400 hover:text-white shrink-0">
                        {copiedField === f.key ? <Check className="w-4 h-4 text-blue-400" /> : <Copy className="w-4 h-4" />}
                      </button>
                    </div>
                  ))}
                ...
                <button
                  onClick={refresh}
                  className="w-full flex items-center justify-center gap-2 h-14 rounded-2xl text-[11px] font-black uppercase tracking-[0.15em] text-zinc-300 hover:text-white border border-zinc-800 hover:border-zinc-800 bg-zinc-900/50 hover:bg-zinc-800 transition-all cursor-pointer"
                >
              ...
              <motion.form key="form" onSubmit={handleGenerate} className="space-y-6">
                <div className="space-y-2.5">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300 ml-1">Server Name (Prefix)</label>
                  <div className="flex items-center gap-3 border border-zinc-800 bg-zinc-900/50  rounded-2xl px-5 py-4 focus-within:border-amber-500/50 focus-within:shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all">
                    <input
                      type="text"
                      value={serverName}
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-300 ml-1">Duration</label>
                ...
                {error && (
                  <div className="flex items-center gap-2 text-zinc-300 text-xs px-4 py-3 rounded-2xl bg-zinc-800 border border-zinc-800 font-bold">
      ...
      <div className="panel rounded-[2rem] overflow-hidden argus-glass text-left border border-zinc-800">
        <div className="px-6 py-5 border-b border-white/[0.04] bg-zinc-900/50">
        ...
        <div className="p-4 sm:p-6">
          {loadingTokens ? (
            ...
            <div className="text-center py-8 text-zinc-400 text-xs font-bold uppercase tracking-widest">No trial links generated yet</div>
          ) : (
            <div className="space-y-3">
              {tokens.map((t) => (
                <div key={t.token} className="p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="font-mono font-bold text-sm text-amber-400 truncate">{t.token}</span>
                      {t.used ? (
                        <span className="px-2 py-0.5 rounded-md bg-zinc-800 border border-zinc-800 text-[9px] font-black text-zinc-300 uppercase tracking-widest">Used</span>
                      ) : (
                        <span className="px-2 py-0.5 rounded-md bg-emerald-500/20 border border-blue-500/20 text-[9px] font-black text-blue-400 uppercase tracking-widest">Active</span>
                      )}
                    </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button onClick={() => {
                      ...
                      }} className="p-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 border border-zinc-800 text-slate-300 transition-colors" title="Copy Link">
                      <Copy className="w-4 h-4" />
                    </button>
                    {tokenToDelete === t.token ? (
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] text-zinc-300 font-bold uppercase">Confirm?</span>
                        <button onClick={() => { setTokenToDelete(null); executeDelete(t.token); }} className="p-2 rounded-xl bg-zinc-800 hover:bg-zinc-800 text-zinc-300 transition-colors">Yes</button>
                        <button onClick={() => setTokenToDelete(null)} className="p-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-slate-300 transition-colors">No</button>
                      </div>
                    ) : (
                      <button onClick={() => setTokenToDelete(t.token)} className="p-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 transition-colors" title="Revoke & Delete">
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-blue-500/10 border border-blue-500/20 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
          <Terminal className="w-6 h-6 text-blue-400" />
        </div>
        <div>
          <h1 className="text-3xl font-black tracking-tight text-white">Developer API</h1>
          <p className="text-sm text-blue-400 font-medium">Automate your workflows programmatically</p>
        </div>
      </div>
      
      <div className="panel rounded-3xl overflow-hidden bg-zinc-900/50  border border-zinc-800 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold flex items-center gap-2">
            <KeyRound className="w-5 h-5 text-blue-400" /> Your API Key
          </h2>
          {apiKey && onResetKey && (
            <button 
              onClick={onResetKey}
              disabled={isResetting}
              className="px-3 py-1.5 bg-zinc-800 hover:bg-zinc-800 text-zinc-300 border border-zinc-800 rounded-lg text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-2 disabled:opacity-50"
            >
        ...
        <div className="flex items-center gap-4 bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
          ...
          {apiKey && (
            <button onClick={copyKey} className="p-2 bg-zinc-800 rounded-lg hover:bg-zinc-700 transition-colors shrink-0">
      ...
      <div className="panel rounded-3xl overflow-hidden bg-zinc-900/50  border border-zinc-800 p-6 space-y-6">
        <div className="flex items-center gap-2 border-b border-zinc-800 pb-4">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-blue-400">Add UID</h3>
              <span className="px-2 py-0.5 rounded text-[10px] font-black bg-emerald-500/20 text-emerald-300 border border-blue-500/20">POST</span>
            </div>
            <p className="text-sm text-zinc-300">Endpoint: <span className="text-white/90 font-mono">/api/uid/add</span></p>
            
            <div className="bg-zinc-900/50 rounded-lg p-4 font-mono text-[11px] sm:text-xs text-slate-300 overflow-x-auto whitespace-pre border border-zinc-800">
{`curl -X POST https://uid-api-server.onrender.com/api/uid/add \\
  ...
  -d '{
    ...
    "days": 30
            ...
            <div className="mt-4 bg-zinc-900/50 rounded-lg p-4 font-mono text-[11px] sm:text-xs text-slate-300 whitespace-pre border border-zinc-800">
{`// Success Response
{
  "success": true,
  "message": "UID whitelisted successfully for 30 days"
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-zinc-300">Remove UID</h3>
              <span className="px-2 py-0.5 rounded text-[10px] font-black bg-zinc-800 text-blue-400 border border-zinc-800">POST</span>
            </div>
            <p className="text-sm text-zinc-300">Endpoint: <span className="text-white/90 font-mono">/api/uid/remove</span></p>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-10">
      ...
      <div className="mb-8 text-left">
        <div className="flex items-center gap-3">
          <User className="w-8 h-8 text-white drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]" />
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
          ...
          <div className="relative shrink-0 cursor-pointer" onClick={() => fileInputRef.current?.click()}>
            <div className="w-28 h-28 rounded-full bg-zinc-900/50 border-2 border-zinc-800 shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden flex items-center justify-center relative hover:border-zinc-800 group/preview transition-all">
              {tempAvatar ? (
          ...
          <div className="flex-grow w-full space-y-5 text-left">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full h-12 px-4 rounded-xl bg-zinc-900/50 border border-zinc-800 text-white font-bold placeholder-slate-600 focus:outline-none focus:border-zinc-800 focus:shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all text-sm"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full h-12 pl-12 pr-4 rounded-xl bg-zinc-900/50 border border-zinc-800 text-white font-bold placeholder-slate-600 focus:outline-none focus:border-zinc-800 focus:shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all text-sm"
                placeholder="••••••••"
              />
            </div>
          </div>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]">Leaderboard</h1>
              ...
              <TiltWrapper>
                <div className="argus-glass rounded-[2rem] p-6 text-center border border-zinc-800 relative overflow-hidden shadow-xl md:h-[280px] flex flex-col justify-between">
                  ...
                  <div className="flex justify-center -mt-12 relative">
                    <div className="w-20 h-20 rounded-full bg-slate-800/80 border-4 border-slate-400 shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden flex items-center justify-center relative">
                      {top2.avatar ? (
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">
                      @{top2.username} <span className="opacity-40">·</span> <span className={top2.role === "admin" ? "text-zinc-300" : "text-white/90"}>{top2.role === "admin" ? "Admin" : "Operator"}</span>
                    </p>
                  </div>
            ...
            >
              <TiltWrapper>
                <div className="argus-glass rounded-[2rem] p-8 text-center border border-yellow-500/30 relative overflow-hidden shadow-2xl md:h-[320px] flex flex-col justify-between" style={{ background: "linear-gradient(135deg, rgba(251,191,36,0.05), rgba(124,58,237,0.05))" }}>
                  <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-yellow-500 via-amber-400 to-yellow-500 shadow-[0_10px_40px_rgba(0,0,0,0.5)]" />
                  
                  <div className="flex justify-center -mt-16 relative">
                    <div className="w-24 h-24 rounded-full bg-zinc-900/50/90 border-4 border-yellow-500 shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden flex items-center justify-center relative">
                      {top1.avatar ? (
                      ...
                      {/* Crown */}
                      <Crown className="w-6 h-6 text-yellow-400 drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)] absolute -top-1 left-1/2 -translate-x-1/2 -translate-y-full animate-bounce" />
                  ...
                  <div className="mt-4">
                    <div className="flex items-center justify-center gap-1.5">
                      ...
                      <Trophy className="w-5 h-5 text-yellow-400 drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)] shrink-0" />
                    </div>
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">
                      @{top1.username} <span className="opacity-40">·</span> <span className={top1.role === "admin" ? "text-zinc-300 font-extrabold" : "text-white/90 font-extrabold"}>{top1.role === "admin" ? "Admin" : "Operator"}</span>
                    </p>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-zinc-800 pt-3">
                    ...
                    <span className="text-2xl font-black text-yellow-400 tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]">{top1.total}</span>
                  </div>
                </div>
              </TiltWrapper>
            </motion.div>
            ...
            >
              <TiltWrapper>
                <div className="argus-glass rounded-[2rem] p-6 text-center border border-zinc-800 relative overflow-hidden shadow-xl md:h-[280px] flex flex-col justify-between">
                  ...
                  <div className="flex justify-center -mt-12 relative">
                    <div className="w-20 h-20 rounded-full bg-slate-800/80 border-4 border-amber-600 shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden flex items-center justify-center relative">
                      {top3.avatar ? (
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">
                      @{top3.username} <span className="opacity-40">·</span> <span className={top3.role === "admin" ? "text-zinc-300" : "text-white/90"}>{top3.role === "admin" ? "Admin" : "Operator"}</span>
                    </p>
                  </div>
      ...
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="argus-glass rounded-[2rem] overflow-hidden relative shadow-2xl border border-zinc-800"
      >
        <div className="flex items-center gap-3 px-6 sm:px-8 py-6 border-b border-zinc-800 bg-zinc-900/50">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-zinc-800" style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.1), rgba(124,58,237,0.05))" }}>
        ...
        {data.length === 0 ? (
          <div className="flex flex-col items-center justify-center p-20 text-center opacity-60">
            ...
            <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Operators will appear here as they register UIDs</p>
          </div>
        ) : (
              ...
              {data.map((user, idx) => (
                ...
                >
                  ...
                  <div className="col-span-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                        @{user.username} <span className="opacity-40">·</span> <span className={user.role === "admin" ? "text-zinc-300 font-extrabold" : "text-white/90 font-extrabold"}>{user.role === "admin" ? "Admin" : "Operator"}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-span-1 sm:col-span-7 grid grid-cols-2 sm:contents gap-x-4 gap-y-1 mt-3 sm:mt-0">
                    {/* Today Count */}
                    <div className="col-span-1 sm:col-span-2 text-left sm:text-center flex sm:block justify-between items-center sm:border-0 border-b border-zinc-800 py-1.5 sm:py-0">
...
function TeamChatView({ currentUsername }: { currentUsername: string }) {
  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col h-[75vh] argus-glass rounded-[2rem] overflow-hidden border border-zinc-800 relative">
      {/* Chat Header */}
      <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-800 bg-zinc-900/50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-zinc-800 border border-zinc-800 flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
      ...
      {/* Messages Stream */}
      <div ref={containerRef} className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar bg-zinc-900/50">
        {messages.length === 0 ? (
      ...
      <form onSubmit={handleSend} className="p-4 border-t border-zinc-800 bg-zinc-900/50 flex items-center gap-3">
        <input
          ...
          className="flex-1 h-12 px-5 rounded-xl bg-zinc-900/50 border border-zinc-800 text-white placeholder-slate-600 text-sm font-bold focus:outline-none focus:border-zinc-800 focus:shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all"
        />
        <button
          type="submit"
          disabled={!text.trim() || sending}
          className="h-12 w-12 rounded-xl bg-white text-black hover:bg-white/90 hover:scale-[1.02] shadow-[0_0_20px_rgba(255,255,255,0.1)] flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
          {sending ? (
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all cursor-pointer text-sm font-semibold
                ${active 
                  ? "bg-zinc-900 border border-zinc-800 text-white shadow-[0_10px_40px_rgba(0,0,0,0.5)] relative" 
...
export default function Dashboard({ username, defaultDays = 30, isTrial = false, canResell = false, onLogout }: DashboardProps) {
  ...
  const renderUidTable = (showFull = false, highlightDelete = false) => {
    ...
    return (
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className={`bg-zinc-900  border border-zinc-800 shadow-[0_20px_40px_rgba(0,0,0,0.6)] rounded-[2.5rem] overflow-hidden relative shadow-2xl ${showFull ? 'h-full' : ''}`}
      >
        <div className="flex items-center justify-between px-6 sm:px-8 py-6 border-b border-zinc-800 bg-zinc-900/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-zinc-800" style={{ background: "linear-gradient(135deg, rgba(0,212,255,0.2), rgba(124,58,237,0.1))" }}>
            ...
            <div>
              ...
              <div className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">{showFull ? "All authorized connections" : "History of recently created UIDs"}</div>
            </div>
          </div>
          <div className="flex items-center gap-4">
            {showFull && (
              <div className="w-64 relative hidden sm:block">
                <Input 
                  ...
                  className="pl-4 pr-4 h-10 rounded-xl bg-zinc-900/50 border-zinc-800 text-white font-bold transition-all focus-visible:ring-cyan-500/30 focus-visible:border-zinc-800"
                />
              </div>
            )}
            {!showFull && (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-wider border border-zinc-800 hover:border-white/20 bg-zinc-900/50 hover:bg-zinc-900 text-slate-300 hover:text-white transition-all cursor-pointer"
            >
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center p-20 text-center opacity-60">
            ...
            <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Register an endpoint to begin routing</p>
          </div>
        ) : (
              ...
              <AnimatePresence>
                {displayedUids.map((uidObj) => (
                  <motion.div
                    ...
                    className={`group flex items-center justify-between p-3.5 sm:p-4 bg-zinc-900/50 border ${highlightDelete ? 'border-zinc-800 shadow-[0_10px_40px_rgba(0,0,0,0.5)]' : 'border-zinc-800'} rounded-2xl hover:bg-zinc-800 hover:border-zinc-800 transition-all`}
                  >
                    <div className="flex items-center gap-4">
  ...
  const renderCreateUid = () => (
    ...
    >
      <TiltWrapper>
        <div className="bg-zinc-900  border border-zinc-800 shadow-[0_20px_40px_rgba(0,0,0,0.6)] rounded-[2.5rem] p-6 sm:p-8 relative overflow-hidden shadow-2xl glow-border">
          <SuccessAnimation active={showSuccessBlast} onComplete={() => setShowSuccessBlast(false)} />
          
          <div className="flex items-center justify-between mb-2 relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-zinc-800" style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.2), rgba(0,212,255,0.1))" }}>
            ...
            {profileData.uidLimit !== -1 && (
              <div className="text-[10px] font-black px-3 py-1.5 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-400 tracking-widest uppercase shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                Limit: {uids.length} / {profileData.uidLimit}
              </div>
            )}
          </div>
          <p className="text-xs font-semibold text-zinc-300 mb-8 relative z-10">Add a new endpoint to the global authorization mesh.</p>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 relative z-10">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-12 h-14 rounded-2xl bg-zinc-900/50 border-zinc-800 focus-visible:ring-cyan-500/30 focus-visible:border-zinc-800 text-white font-bold transition-all shadow-inner"
                  {...form.register("name")}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-zinc-400 group-focus-within:text-white/90 transition-colors pointer-events-none" />
                <Input
            ...
            <div className="space-y-2 relative z-50">
              <div className="flex items-center justify-between ml-1">
                <label className="text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em]">Duration</label>
                {isTrial ? (
              ...
              {isTrial ? (
                <div className="flex items-center gap-3 h-14 px-5 rounded-2xl text-sm font-bold opacity-50 cursor-not-allowed bg-zinc-900/50 border border-zinc-800 shadow-inner">
            ...
            <div className="flex items-center justify-between p-5 rounded-2xl bg-zinc-900/50 border border-zinc-800 group hover:border-zinc-800 hover:bg-zinc-900/50 transition-all shadow-inner">
              <div>
                <div className="flex items-center gap-2 text-sm font-black text-white">
                  <Monitor className="w-4 h-4 text-white/90 drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]" />
                  BlueStack Protocol
                </div>
              ...
              <Switch
                ...
                className="data-[state=checked]:bg-cyan-500 data-[state=checked]:shadow-[0_10px_40px_rgba(0,0,0,0.5)]"
              />
            </div>

            {!isTrial && (
              <div className="flex items-center justify-between px-4 py-3 rounded-xl text-[11px] font-black uppercase tracking-wider " style={{ background: hasEnoughBalance ? "rgba(16,185,129,0.08)" : "rgba(255,255,255,0.1)", border: `1px solid ${hasEnoughBalance ? "rgba(16,185,129,0.2)" : "rgba(255,255,255,0.1)"}` }}>
    ...
    <div className="flex h-[100dvh] bg-transparent text-white font-sans overflow-hidden relative">
      ...
      <AnimatePresence>
        {mobileSidebarOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[60] bg-zinc-900/50  lg:hidden"
      ...
      <AnimatePresence>
        ...
        <div className="h-20 flex items-center justify-between px-6 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.5)]" style={{ background: "linear-gradient(135deg, #ff006e, #7c3aed)" }}>
              <Shield className="w-5 h-5 text-white" />
            </div>
            <div>
              <div className="font-black text-[11px] uppercase tracking-[0.1em] text-white">UID BYPASS PANEL</div>
              <div className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest mt-0.5">SM</div>
            </div>
          </div>
      ...
      <aside className="hidden lg:flex w-64 bg-zinc-900/50  border-r border-zinc-800 flex-col z-50 shrink-0 shadow-[10px_0_30px_rgba(0,0,0,0.5)]">
        {/* Sidebar Logo Area */}
      ...
      <main className="flex-1 relative flex flex-col overflow-hidden h-full min-w-0">
        ...
        {/* Main Content Header */}
        <header className="h-16 lg:h-20 shrink-0 border-b border-zinc-800 px-4 lg:px-8 flex items-center justify-between relative z-20 bg-zinc-900  border border-zinc-800 shadow-[0_20px_40px_rgba(0,0,0,0.6)]-panel rounded-b-3xl mx-2 lg:mx-4 mt-2 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] text-zinc-300">
              <span className="hidden sm:block">USER TERMINAL</span>
              <span className="text-slate-600 hidden sm:block">/</span>
              <span className="text-white drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)] uppercase">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {!isTrial && (
              <div className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-wider shadow-[0_10px_40px_rgba(0,0,0,0.5)] border" style={{ background: "rgba(59,130,246,0.1)", color: "#60a5fa", borderColor: "rgba(59,130,246,0.25)" }}>
            ...
            {username && (
              <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-zinc-800 bg-zinc-900 text-xs text-slate-300 font-bold shadow-inner">
                {profileData.avatarBase64 ? (
                  <img src={profileData.avatarBase64} alt="Avatar" className="w-5 h-5 rounded-full object-cover shadow-[0_10px_40px_rgba(0,0,0,0.5)]" />
                ) : (
            ...
            {!isTrial && balance !== null && (
              <div className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-wider shadow-[0_10px_40px_rgba(0,0,0,0.5)] border" style={{ background: balance > 0 ? "rgba(16,185,129,0.1)" : "rgba(255,255,255,0.1)", color: balance > 0 ? "#10b981" : "#ef4444", borderColor: balance > 0 ? "rgba(16,185,129,0.25)" : "rgba(255,255,255,0.1)" }}>
            ...
            <AnimatePresence mode="wait">
              {activeSidebarTab === "dashboard" && (
                <motion.div key="dashboard" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-8">
                  ...
                  <div>
                    <div className="flex items-center gap-3">
                      <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]">Overview</h1>
                      <span className="px-2.5 py-1 rounded-md bg-zinc-700 border border-white/20 text-[9px] font-black tracking-widest text-white mt-1">v5.0-STABLE</span>
                    </div>
                    <p className="text-zinc-300 font-semibold text-sm mt-2">Real-time status of all active UIDs</p>
                  </div>
      ...
      <AnimatePresence>
        {showAnnouncement && activeNotice && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-900/50 "
          >
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: -20 }}
              className="w-full max-w-lg bg-zinc-900/50  border border-zinc-800 rounded-[2rem] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.5)] relative text-left"
            >
              ...
              <div className="p-6 sm:p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-zinc-800 border border-zinc-800 flex items-center justify-center shrink-0 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                ...
                <div className="p-5 rounded-2xl bg-zinc-900/50 border border-zinc-800 mb-8">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="h-12 px-8 rounded-xl bg-white text-black hover:bg-white/90 hover:scale-[1.02] shadow-[0_0_20px_rgba(255,255,255,0.1)] font-black text-[11px] uppercase tracking-[0.2em] transition-all shadow-[0_10px_40px_rgba(0,0,0,0.5)] flex items-center gap-2"
                  >
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[100] group flex items-center justify-center w-14 h-14 rounded-full bg-zinc-900/50 border border-zinc-800 shadow-[0_10px_40px_rgba(0,0,0,0.5)]  hover:bg-zinc-800 hover:scale-110 hover:border-zinc-800 hover:shadow-[0_10px_40px_rgba(0,0,0,0.5)] active:scale-95 transition-all duration-300"
      >
        <MessageSquare className="w-6 h-6 text-white/90 group-hover:text-white/90 transition-colors" />
        <span className="absolute top-0 right-0 flex h-3.5 w-3.5">
          
          <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-red-500 shadow-[0_10px_40px_rgba(0,0,0,0.5)] border-2 border-black/50"></span>
        </span>
      </button>
...
function LoginHistoryPanel() {
  ...
  return (
    <div className="bg-zinc-900  border border-zinc-800 shadow-[0_20px_40px_rgba(0,0,0,0.6)] rounded-3xl overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.6)] glow-border">
      <div className="px-6 py-6 border-b border-white/[0.04] flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-zinc-900 border border-zinc-800 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            <Clock className="w-6 h-6 text-white/90 drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]" />
          </div>
          <div>
              ...
              <tbody>
                {history.map((record, i) => (
                  <tr key={i} className="border-b border-white/[0.03] hover:bg-zinc-900 transition-all group">
                    <td className="py-4 px-6 font-black text-sm text-white group-hover:text-white/90 transition-colors drop-shadow-[0_10px_40px_rgba(0,0,0,0.5)]">{record.username}</td>
                    <td className="py-4 px-6">
                      {record.success ? (
                        <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-emerald-300 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-800 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-blue-400 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                          <span className="relative flex h-1.5 w-1.5">
