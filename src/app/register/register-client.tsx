  ...
  return (
    <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none bg-[#06060f]">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-fuchsia-600/20 rounded-full blur-[120px] mix-blend-screen animate-float-slow" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-600/30 rounded-full blur-[120px] mix-blend-screen animate-float" style={{ animationDelay: '-3s' }} />
      ...
      >
        <div className="glass-premium rounded-2xl p-8 sm:p-10 order-2 md:order-1 relative overflow-hidden shadow-[0_0_40px_rgba(139,92,246,0.1)]">
